...
const PeopleSVG = (props: VideoSVGProps) => {
  return (
  <Svg
    width={22}
    height={21}
  ...
  >
    ...
    />
    <Path
      d="M15 11C16.933 11 18.5 9.433 18.5 7.5C18.5 5.567 16.933 4 15 4M17.3899 20H19.433C20.2984 20 21 19.2984 21 18.433C21 16.4308 19.5451 14.7254 17.568 14.4098C17.4494 14.3909 17.3293 14.3814 17.2093 14.3814C16.8895 14.3814 16.7902 14.3814 16.2412 14.3814"
      stroke="#999999"
      strokeWidth={1.5}
      strokeLinecap="round"
    />
